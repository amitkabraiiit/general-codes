...
public class CallHandler1 {
	private static CallHandler1 instance;
	...
	protected CallHandler1() {
	}

	// get instance of singleton class
	public static CallHandler1 getInstance() {
		if (instance == null)instance = new CallHandler1();
		return instance;
	}
