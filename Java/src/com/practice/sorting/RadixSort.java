...
public class RadixSort {
    ...
    /**
     * 1th(1th) place , 2nd(10th) place , 3rd(100th) place etc.
     */
    private static int[] countingSortForNthPlace(int[] input, int place){
        int[] out = new int[input.length];
 
        // since for every place we are just sorting 0-9 digits
